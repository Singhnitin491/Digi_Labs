...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      ...
      description: "Your success is our success. We treat every client like a partner, not just a transaction.",
    },
    {
      icon: TrendingUp,
      title: "Growth-Minded",
      description: "We stay ahead of trends and constantly learn. Your competitive advantage is our priority.",
    },
    {
      icon: Heart,
      title: "Transparent",
      description: "No fluff, no smoke and mirrors. We communicate clearly about what's working and what isn't.",
    },
  ]
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-xl text-gray-600 max-w-2xl">
              Founded by digital marketing experts, DigitalGrowth Labs is dedicated to delivering measurable results for
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  To transform businesses through data-driven marketing strategies that generate real revenue and
                  sustainable growth.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  A world where every ambitious entrepreneur has access to world-class marketing expertise and achieves
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Strategy first, execution second. We analyze your business, craft a custom plan, then execute
                  flawlessly for maximum ROI.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-900 mb-12">Why Choose DigitalGrowth Labs?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {[
                ...
                { title: "Expert Team", desc: "Former VP-level marketers with deep expertise in all channels" },
                { title: "Results Guarantee", desc: "30-day money-back guarantee on all services" },
                {
                  title: "Custom Strategies",
                  desc: "No cookie-cutter solutions. Every plan is tailored to your business",
                },
                { title: "Full Transparency", desc: "Monthly reports, strategy calls, and complete accountability" },
                { title: "Scalable Support", desc: "Grow from startup to 7-figures with our proven systems" },
              ].map((item, idx) => (
        ...
        <section className="bg-gray-50 py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {team.map((member, idx) => (
                <div key={idx} className="glass p-6 text-center hover:shadow-lg transition-all duration-300">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl font-bold mb-6">Ready to Work With Us?</h2>
            <p className="text-xl text-blue-100 mb-8">
              {"Let's"} discuss your growth goals and build a strategy that works.
            </p>
            <Link
              href="/contact"
